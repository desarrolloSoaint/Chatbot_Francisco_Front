...
export class SoniatComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  tittleChatBox:string="FRANCISCO";
  ...
  ngOnInit() {
    ...
    this.saveMessage("Hola me llamo FRANCISCO y seré tu asesor de seguros durante la consulta, por favor coméntame ¿En qué puedo ayudarte?",false)
  }
  ngAfterViewInit(){
    this.scrollToBottom();
